...
### Open Bounties
These open and smaller bounties can be claimed and worked on by anyone until closed by a mod. Be curtious and mention with a comment that you are working on the bounty so it can be labeled as In Progress early on and you as the claimer. See the instructions below for submmitting your fix.
